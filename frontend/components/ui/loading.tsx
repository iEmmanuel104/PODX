            ...
            <div className="flex flex-col gap-[487px]">
                <div className="flex flex-col gap-[76px] items-center">
                    <h2
                     ...
                     text-transparent bg-clip-text bg-gradient-to-r from-[#D7B35D] via-white to-[#552FC9] bg-300% animate-podx-gradient ${mortendBold.className}`}
                    >
                        PODX
                    </h2>
                    <p
                        className="text-2xl font-medium text-transparent bg-clip-text bg-gradient-to-t from-[#6E6E6E] to-[#D4D4D4]"
                ...
                <div className="w-full flex justify-between items-center">
                    ...
                    <div className="socials flex gap-[8px]">
                        <a href="https://t.me/podx_fun" target="_blank" rel="noopener noreferrer" title="Join us on Telegram" className="social-icon h-[24px] w-[24px]">
                            <Telegram />
                        </a>
                        {/* <a href="#!" target="_blank" className="social-icon h-[24px] w-[24px]">
                                <Facebook />
                            </a> */}
                        <a href="https://x.com/podx_fun" target="_blank" rel="noopener noreferrer" title="Follow us on X" className="social-icon h-[24px] w-[24px]">
                            <X />
                        </a>
                    </div>
                </div>

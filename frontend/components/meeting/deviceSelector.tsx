...
export const AudioInputDeviceSelector: React.FC<{ disabled?: boolean; className?: string }> = ({
    disabled = false,
    className = '',
}) => {
...
export const VideoInputDeviceSelector: React.FC<{ disabled?: boolean; className?: string }> = ({
    disabled = false,
    className = '',
}) => {
...
export const AudioOutputDeviceSelector: React.FC<{ disabled?: boolean; className?: string }> = ({
    disabled = false,
    className = '',
}) => {
    ...
    return (
        <DeviceSelector
            devices={devices}
            selectedDeviceId={
                selectedDevice ? selectedDevice : devices ? devices[0]?.deviceId : undefined
            }

    ...
    return (
        <div className="min-h-screen bg-[#1C1C1C] flex flex-col items-center justify-between p-8 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <Button variant="default" className="bg-[#6C5DD3] hover:bg-[#5648B3] text-white px-8">
                    Back home
                </Button>
            </div>
            ...
            <div className="w-full max-w-md flex flex-col items-center gap-2">
                <h2 className="text-white text-lg font-medium">Help us improve our product for you</h2>
                ...
                <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                        <button key={star} onClick={() => setRating(star)} className="focus:outline-none">
                            <Star className={`w-6 h-6 ${star <= rating ? "fill-yellow-400 text-yellow-400" : "text-gray-600"}`} />
                        </button>
                    ))}
                </div>
                ...
                <div className="mt-8 flex items-center gap-2 bg-black/30 rounded-full px-4 py-2">
                    <span className="text-white text-sm">You've received a proof of attendance</span>

...
const VideoPlaceholder = forwardRef<HTMLDivElement, VideoPlaceholderProps>(function VideoPlaceholder({ style }, ref) {
    ...
    return (
        ...
        >
            ...
            >
                <span className="text-[clamp(30px,_calc(100vw_*_0.05),_65px)] select-none">{name[0]}</span>
            </div>
        </div>
    );
});

...
const SpeakerLayout: React.FC = () => {
    ...
    return (
        <div className="w-full h-full relative overflow-hidden">
            <div className="h-3/4 bg-[#2C2C2C] rounded-[10px] overflow-hidden mb-2">
                ...
                <div className="h-1/4" ref={setParticipantsBar}>
                    <div className="flex overflow-x-auto gap-2 h-full">
                        {otherParticipants.map((participant) => (
                            <div key={participant.sessionId} className="flex-shrink-0 aspect-video bg-[#2C2C2C] rounded-[10px] overflow-hidden relative">

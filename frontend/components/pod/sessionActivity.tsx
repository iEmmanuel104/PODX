...
import { ArrowUpRight, ArrowUpLeftIcon as ArrowUturnLeft, Eye, EyeOff, LinkIcon, Wallet } from "lucide-react"
            ...
            <div className="max-w-[800px] mx-auto">
                ...
                <div className="w-1/2 mx-auto flex flex-col gap-14">
                    ...
                    <div className="flex flex-col items-center gap-4 mb-16">
                        ...
                        <div className="text-sm text-white/60">{isBalanceHidden ? "****" : "~USD 50.01"}</div>
                        <div className="flex gap-4 mt-2">
                            <Button className="bg-[#6032F6] hover:bg-[#6032F6]/90 py-5">
                                <Wallet className="h-4 w-4 mr-2" />
                                Load Wallet
                            </Button>
                            <Button variant="outline" className="border-white/10 bg-transparent text-white hover:text-white hover:bg-white/5 py-5">
                ...
                <div>
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex gap-2">
                            ...
                            <Button
                                variant="ghost"
                                className={`rounded-full px-4 ${activeTab === "tips" ? "bg-[#DDB958] text-black" : "text-white/60 hover:text-white hover:bg-white/5"
                                    }`}
                                    ...
                                    <tr key={index} className="text-sm">
                                        {activeTab === "history" && (
                                            <>
                                                ...
                                                <td className="p-4">
                                                    <span className="px-2 py-1 rounded-full bg-white/10">{session.sessionType}</span>
                                                </td>
                                        ...
                                        {activeTab === "attendance" && (
                                            <>
                                                ...
                                                <td className="p-4 text-[#69CB58]">{session.poaStatus}</td>
                                                <td className="p-4">
                                                    <span className="px-2 py-1 rounded-full bg-white/10">{session.sessionType}</span>
                                                </td>
                                                <td className="p-4">
                                                    <Button variant="link" className="text-[#6032F6] p-0 h-auto">
                                                        View transaction
                                                    </Button>
                                                </td>
                                            </>

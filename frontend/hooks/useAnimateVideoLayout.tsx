...
const useAnimateVideoLayout = (isSpeakerLayout: boolean) => {
    ...
    useGSAP(
        (_, contextSafe) => {
            ...
            const container = (
                isSpeakerLayout
                    ? ref.current!.querySelector('.str-video__speaker-layout__participants-bar')
                    : ref.current!.querySelector('.str-video__paginated-grid-layout__group')
            ) as HTMLElement;
            ...
            const animateItems = contextSafe!(() => {
                ...
                items.forEach((item, index) => {
                    ...
                    const getTranslateValues = () => {
                        ...
                        } else if (index === 0 && items.length === 2 && prevPosition.total === 1) {

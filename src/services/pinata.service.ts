...
export class PinataService {
    ...
    static async createNFTMetadata(input: NFTMetadataInput): Promise<NFTMetadataOutput> {
        try {
            ...
            const metadataContent = {
                ...
                external_url: input.callDetails?.roomId ? 
                    `${process.env.FRONTEND_URL || 'https://app.podx.xyz'}/calls/${input.callDetails.roomId}` : undefined,

...
export class StreakController {
    static async recalculateUserStreak(req: AuthenticatedRequest, res: Response) {
    ...
    static async syncStreaksWithStreamIO(req: Request, res: Response) {
    ...
    static async recalculateAllStreaks(req: Request, res: Response) {
